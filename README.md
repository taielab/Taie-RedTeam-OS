...
## 特殊声明
 ...
 因国内开源环境太过恶劣，后续泰阿红队单兵作战系统3.0新版不会继续开源，已有的镜像下载地址全部取消只留md5给之前下载的作为检验系统是否原版，泰阿红队单兵作战系统3.0所有新版全自动化特性和更深度定制工具全部不会外放转为内测。后续泰阿安全实验室还会出蓝队单兵系统同样不会开源。至于后面会不会外放内测邀请到时候再看，有缘江湖再见👋。
